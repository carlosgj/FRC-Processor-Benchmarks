...
void main()
{
    ...
    printf("\n  MP-Whetstone Benchmark %s\n", timeday);
    printf("      MFLOPS 1   MFLOPS 2    If MOPS   Int MOPS  Trig MOPS   MFLOPS 3 Equal MOPS   Exp MOPS      MWIPS\n");

    fprintf(outfile, "\n  MP-Whetstone Benchmark %s\n", timeday);
    fprintf(outfile, "      MFLOPS 1   MFLOPS 2    If MOPS   Int MOPS  Trig MOPS   MFLOPS 3 Equal MOPS   Exp MOPS      MWIPS\n");
    ...
    for(t=0; t<2; t++)
    {
        ...
        fprintf(outfile, "%10.1f %10.1f %10.1f %10.1f %10.1f %10.1f %10.1f %10.1f %10.1f\n", 
                          total[t][1], total[t][2], total[t][3], total[t][4],
                          total[t][5], total[t][6], total[t][7], total[t][8], total[t][9]);
        fflush(stdout);                
        fflush(outfile);                
    }
    printf("\n   Overall Seconds %6.2f 1T, %6.2f %dT\n\n%s\n\n", 
             timeTot[0], timeTot[1], passThreads[1], errorMsg);                        
    fprintf(outfile, "\n   Overall Seconds %6.2f 1T, %6.2f %dT\n\n%s\n\n", 
             timeTot[0], timeTot[1], passThreads[1], errorMsg);                        
